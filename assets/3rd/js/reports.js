...
$('#report4-nav-item').click(function() {
    var $data = getData(window.BASE_URL + '/rest/reports/yearly');
    ...
    $data.success(function (data) {
        if (data.success)
        {
            ...
            $.each(data.data.collection, function (index, yearly_data) {
                options.xAxis.categories.push(yearly_data.year);
                sl_count.push(parseInt(yearly_data.count));
...
$('#report5-nav-item').click(function() {
    var $data = getData(window.BASE_URL + '/rest/reports/yearly?category=department');
    ...
    $data.success(function (data) {
        if (data.success)
        {
            ...
            $.each(data.data.collection, function (index, dept_data) {
                var xIndex = $.inArray(dept_data.year, options.xAxis.categories);
                if (xIndex == -1)
                {
                    options.xAxis.categories.push(dept_data.year);
                    xIndex = options.xAxis.categories.length-1;
                }
...
$('#report6-nav-item').click(function() {
    var $data = getData(window.BASE_URL + '/rest/reports/yearly?category=individual');
    ...
    $data.success(function (data) {
        if (data.success)
        {
            ...
            var length = data.data.collection.length;
            $.each(data.data.collection, function (index, ind_data) {
                var xIndex = $.inArray(ind_data.year, options.xAxis.categories);
                if (xIndex == -1)
                {
                    options.xAxis.categories.push(ind_data.year);
                    xIndex = options.xAxis.categories.length-1;
                }
