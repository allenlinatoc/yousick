...
{
    case 'individual' : {
        die(new ModelResponse(true, 'Success', new Models\Reports\YearlyIndividualList()));
        break;
    }
    case 'department' : {
        die(new ModelResponse(true, 'Success', new \Models\Reports\YearlyDepartmentList()));
        break;
    }
    default: {
        die(new ModelResponse(true, 'Success', new Models\Reports\YearlyOverallList()));
    }
}